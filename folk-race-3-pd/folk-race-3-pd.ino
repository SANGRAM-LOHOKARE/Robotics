...
void trackFollowing()
{
  ...
  error = ir_dist_A - ir_dist_B;

  filtered_error = (error + prev_error + prev_error2) / 3;
  ...
  correction = (KP * filtered_error) + (KD * derivative);
  correction = constrain(correction, 0, 185); //-------------------------------------------to be calibrated

  //speed control

  speed = constrain(speed, 70, 255); //----------------------------------------------to be changed
